      ...
      <div className="container mx-auto px-4 md:px-6">
        <Card className="max-w-4xl mx-auto overflow-hidden shadow-lg">
          <div className="md:flex">
            <div className="md:w-1/3 bg-primary text-primary-foreground p-8 flex flex-col items-center justify-center">
              <Avatar className="h-32 w-32 border-4 border-primary-foreground/50 mb-4">
